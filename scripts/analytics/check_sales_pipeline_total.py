...
# Break down Sales by close_date quarter
q3_sales = [d for d in sales_deals if d.get('close_date') and '2026-05-01' <= d.get('close_date') <= '2026-07-31']
q4_sales = [d for d in sales_deals if d.get('close_date') and '2026-08-01' <= d.get('close_date') <= '2026-10-31']
future_sales = [d for d in sales_deals if d.get('close_date') and d.get('close_date') > '2026-10-31']
...
print(f'  Q3 (May-Jul):      {len(q3_sales):3d} deals  ${q3_value:>12,.0f}')
print(f'  Q4 (Aug-Oct):      {len(q4_sales):3d} deals  ${q4_value:>12,.0f}')
print(f'  Future (Nov+):     {len(future_sales):3d} deals  ${future_value:>12,.0f}')
print(f'  No close_date:     {len(no_date_sales):3d} deals  ${no_date_value:>12,.0f}')
print(f'')

# Show top 10 Q3 Sales deals
if q3_sales:
    print(f'Top 10 Q3 Sales deals:')
